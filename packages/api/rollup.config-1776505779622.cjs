...
const pkg = JSON.parse(fs.readFileSync(new URL('./package.json', 'file:///D:/Acco%20job%20project/LibreChat-Contact-Workspace-Integration-main/packages/api/rollup.config.js'), 'utf8'));
